    ...
    Template.chat_messages_pane.events
        'keydown .add_message': (e,t)->
            ...
            if e.which is 13
                ...
                if body.length > 0
                    Meteor.call 'add_message', body, chatroom_id, (err,res)=>
...
if Meteor.isServer
    Meteor.methods
        add_message: (body,chatroom_id)->
            ...
            chat_doc = Docs.findOne _id: chatroom_id
